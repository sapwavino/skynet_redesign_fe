...
<template>
  <div class="">
    ...
    <div
        v-if="tab === 'new'"
        class="flex md:flex-row flex-col gap-y-5 items-center md:items-start"
    >
      <div class="w-9/12">
            ...
            <div v-if="Object.keys(service).length > 0">
              ...
              <div class="flex flex-col gap-4 mb-5">
                ...
                >
                  ...
                  > </label>
                  <div
                      class="peer-checked:border-transparent peer-checked:bg-blue-400 peer-checked:ring-2 absolute left-4 h-5 w-5 rounded-full border-2 border-gray-300 bg-gray-200 ring-blue-400 ring-offset-2 "
                  ></div>
