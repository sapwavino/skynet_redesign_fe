...
export default {
  ...
  methods: {
    ...
    handleSelectedDomain(selectedDomain) {
      if (selectedDomain) {
        this.domain = selectedDomain.sld + selectedDomain.tld
        this.domainChecked = true
      }
    }
  },
...
<template>
  ...
  <transition name="fade">
    <section v-if="currentStep === 1"
             class="shadow rounded-md p-5 flex flex-col md:block"
    >
      ...
      <div class="grid md:grid-cols-3 gap-5 w-3/4 mx-auto p-5">
        ...
        >
          <svg
              :class="{'fill-customGold': appType === 'js'}"
              class="dark:fill-customGold"
              height="4rem"
              viewBox="0 0 448 512"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <section
            ...
            class="hostingConfigureAppCard"
            @click="appType = 'python'"
        >
          <svg
              :class="{'fill-customGold': appType === 'python'}"
              class="dark:fill-customGold"
              height="4rem"
              viewBox="0 0 448 512"
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <svg id="Layer_1"
               :class="{'fill-customGold': appType === 'go'}"
               class="dark:fill-customGold"
               height="4rem"
        ...
        >
          <svg
              :class="{'fill-customGold': appType === 'c#'}"
              class="dark:fill-customGold"
              height="4rem"
        ...
        >
          <svg
              :class="{'fill-customGold': appType === 'ruby'}"
              class="dark:fill-customGold"
              height="4rem"
        ...
        >
          <svg
              :class="{'fill-customGold': appType === 'perl'}"
              class="dark:fill-customGold"
              height="4rem"
              viewBox="0 0 43.17 48.65"
              xmlns="http://www.w3.org/2000/svg"
          >
            <path
        ...
        <section
            ...
            class="hostingConfigureAppCard"
            @click="appType = 'html&css'"
        >
          <svg
              :class="{'fill-customGold': appType === 'html&css'}"
              class="dark:fill-customGold"
              height="4rem"
              viewBox="0 0 384 512"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <section
            ...
            class="hostingConfigureAppCard"
            @click="appType = 'undecided'"
        >
          <svg
              :class="{'fill-customGold': appType === 'undecided'}"
              class="dark:fill-customGold"
              height="4rem"
              viewBox="0 0 512 512"
              xmlns="http://www.w3.org/2000/svg"
      ...
      <transition name="slowFade">
        <button v-show="appType !== ''"
                class="btn-base mt-3"
                @click="currentStep = 2"
        >Choose Hosting Panel
        </button>
      </transition>
    </section>
  </transition>
  ...
  <transition name="fade">
    <section v-if="currentStep === 2">
      <div class="grid md:grid-cols-2 md:w-1/2 mx-auto">
        <section
...
<!--            <rect class="st0" width="500" height="500"/>-->
        ...
        <section class="md:col-span-2 my-10 mx-auto">
          <div class="flex items-center">
            <h2 class="font-bold text-xl text-center">Number of Hosting Panels</h2>
      ...
      <section v-if="preferredPanel !== ''">
        <transition name="fade">
          <section v-if="currentDomainStep === 1"
                   class="h-[8vh] w-3/4 mx-auto mt-5"
          >
            <form>
              <div class="">
                <label class="muteSmallSubheader"
                       for="domain"
                >
                  Domain name
                </label>
        ...
        <transition name="fade">
          <!--      DOMAIN CONFIG-->
          <section v-if="currentDomainStep === 2"
