    ...
    <div class="flex flex-wrap md:flex-nowrap items-center gap-4 mt-5">
      ...
      <section class="dashGroupCard w-full md:w-1/3">
        ...
        <div class="flex flex-wrap justify-center gap-4 mt-5">
          <Tooltip :message="activeDomains" position="top" color="bg-green-700">
          ...
          <Tooltip :message="expiredDomains" position="top" color="bg-red-700">
        ...
        <button class="dash-card-btn-base w-full mt-5" @click="$router.push('/dashboard/domains?tab=manage')">
          Manage Domains
        </button>
        <button class="dash-card-btn-base w-full mt-2 mb-5" @click="$router.push('/dashboard/domains?tab=buy')">
          Buy New Domain
        </button>
      </section>
      ...
      <section class="dashGroupCard w-full md:w-1/3">
        ...
        <button class="dash-card-btn-base w-full mt-3" @click="$router.push('/dashboard/cloud?tab=manage')">Manage
          Cloud
        </button>
      </section>
    </div>
    ...
    <div class="flex flex-wrap md:flex-nowrap items-center gap-4 mt-5">
      ...
      <section class="dashGroupCard w-full md:w-1/3 flex flex-col items-center">
        ...
        <div class="flex flex-col items-center bg-gray-300 p-5 rounded-3xl w-full md:w-3/4">
          <svg xmlns="http://www.w3.org/2000/svg" height="5rem" viewBox="0 0 888 710.80704">
            <path
            ...
            <rect x="313" y="417.90372" width="262" height="16" fill="#EABE63"/>
            <rect x="313" y="533.90372" width="262" height="16" fill="#EABE63"/>
            <rect x="313" y="649.90372" width="262" height="16" fill="#EABE63"/>
            <circle cx="524" cy="388.80743" r="6" fill="#EABE63"/>
            <circle cx="545" cy="388.80743" r="6" fill="#EABE63"/>
            <circle cx="566" cy="388.80743" r="6" fill="#EABE63"/>
            <circle cx="524" cy="502.80743" r="6" fill="#EABE63"/>
            <circle cx="545" cy="502.80743" r="6" fill="#EABE63"/>
            <circle cx="566" cy="502.80743" r="6" fill="#EABE63"/>
            <circle cx="524" cy="616.80743" r="6" fill="#EABE63"/>
            <circle cx="545" cy="616.80743" r="6" fill="#EABE63"/>
            <circle cx="566" cy="616.80743" r="6" fill="#EABE63"/>
            ...
            <rect x="171.14869" y="387.63152" width="56.81724" height="2.09827" fill="#EABE63"/>
            ...
            <rect x="154.53324" y="386.58238" width="4.19655" height="4.19655" fill="#EABE63"/>
            ...
            <rect x="376.74025" y="67.80733" width="75.70547" height="2.79582" fill="#EABE63"/>
            ...
            <rect x="354.60119" y="66.40942" width="5.59164" height="5.59164" fill="#EABE63"/>
            ...
            <rect x="321.00559" width="245.88383" height="10.44604" fill="#EABE63"/>
            ...
            <rect x="688.84621" y="361.46796" width="46.80151" height="1.72839" fill="#EABE63"/>
            ...
            <rect x="675.15972" y="360.60376" width="3.45678" height="3.45678" fill="#EABE63"/>
        ...
        <button class="dash-card-btn-base w-full mt-3 capitalize" @click="$router.push('/dashboard/database')">Set up
          database
        </button>
      </section>
      ...
      <section class="dashGroupCard w-full md:w-1/3">
        ...
        <div class="flex flex-col items-center gap-4 mt-3">
          <div class="flex flex-col items-center bg-gray-300 p-5 rounded-3xl w-full md:w-3/4">
            <svg xmlns="http://www.w3.org/2000/svg" height="5rem" viewBox="0 0 576.49928 493.5"
              ...
              <path
                  ...
                  transform="translate(-311.75036 -203.25)" fill="#EABE63"/>
              <path
