  ...
  <div class="min-h-screen">
    ...
    <div class="mb-8">
      <h1 class="header uppercase flex items-center">
        <font-awesome-icon :icon="faComments" class="mr-3 text-customGold" />
        Support Center
      </h1>
    ...
    >
      ...
      >
        <li class="me-2" @click="setTab('all')">
          <a
            href="#"
            :class="{
        ...
        <li class="me-2" @click="setTab('open')">
          <a
            href="#"
            :class="{
        ...
        <li class="me-2" @click="setTab('on_hold')">
          <a
            href="#"
            :class="{
        ...
        <li class="me-2" @click="setTab('closed')">
          <a
            href="#"
            :class="{
        ...
        >
          ...
          >
            <div class="flex items-center">
              <font-awesome-icon :icon="faCalendarAlt" class="mr-1" />
      ...
      >
        ...
        >
          ...
          >
            <button
              type="button"
              class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-customGold text-base font-medium text-white hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 sm:ml-3 sm:w-auto sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              type="button"
              class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 dark:border-gray-600 shadow-sm px-4 py-2 bg-white dark:bg-gray-800 text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-customGold sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
              @click="closeModal"
            >
              Cancel
            </button>
    ...
    <button
      class="fixed bottom-6 right-6 btn-base rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center"
      @click="openModal"
    >
      <font-awesome-icon :icon="faPlus" class="text-xl" />
    </button>
  </div>
</template>
