...
export default {
    ...
    return {
      slides: [
        ...
        },
        {
          ...
          subheader: 'Find our one-click setups for your business apps, databases and services like Wordpress, Open Source AI Models(Llama 3.5, Deepseek R1, etc). You don\'t have to create everything from scratch everytime',
          buttons: [
            {
  ...
  methods: {
    ...
    formatNumber(value) {
      let parts = parseFloat(value).toString().split(".");
