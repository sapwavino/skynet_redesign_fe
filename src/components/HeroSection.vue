...
<template>
  <section class="hero">
    ...
    <!--           :key="idx"-->
    <!--           class="h-[75vh] p-4 flex gap-5 p-14 justify-between bg-gradient-to-tr from-gray-900 via-yellow-700/80 from-30% via-75% to-gray-900 text-gray-50"-->
    <!--      >-->
    <!--        <section class="flex flex-col gap-4 justify-center w-2/3 px-5">-->
    <!--          <h2 class="header text-customGold">-->
    <!--            {{ slide.header }}-->
    <!--          </h2>-->
