<template>
  <div class="md:hidden"
       @click.stop="$store.commit('SET_SHOW_MOBILE_NAV', false)"
  >
    <transition name="slowFade">
      <div v-if="$store.state.showMobileNav"
    ...
    <transition name="slide-fade">
      <div v-if="$store.state.showMobileNav"
           class="mobile-nav-drawer dark:bg-gray-700 bg-white"
      >
        <router-link to="/">
          <img alt="Logo"
               class="h-16 "
        ...
        >
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard', 'mobile-nav-item-inactive' : $route.path !== '/dashboard'}"
              @click="navigateTo('/dashboard')"
          >
            <button class="flex items-center gap-x-2">
              <svg :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard', 'fill-gray-400': $route.path !== '/dashboard'}"
                   class=""
                   height="1.6rem"
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/domains', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/domains'}"
              @click="navigateTo('/dashboard/domains?tab=buy')"
          >
            <button class="flex items-center gap-x-2">
              <svg
                  :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/domains', 'fill-gray-400': $route.path !== '/dashboard/domains'}"
                  height="1.7rem"
                  viewBox="0 0 64 80"
                  x="0px"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/hosting', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/hosting'}"
              @click="navigateTo('/dashboard/hosting?tab=new')"
          >
            <button class="flex items-center gap-x-2">
              <svg :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/hosting', 'fill-gray-400': $route.path !== '/dashboard/hosting'}"
                   height="1.2rem"
                   viewBox="0 0 512 512"
                   xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/cloud', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/cloud'}"
              @click="navigateTo('/dashboard/cloud?tab=new')"
          >
            <button class="flex items-center gap-x-2">
              <svg :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/cloud', 'fill-gray-400': $route.path !== '/dashboard/cloud'}"
                   class=""
                   height="1.2rem"
                   viewBox="0 0 640 512"
                   xmlns="http://www.w3.org/2000/svg"
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/email', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/email'}"
              @click="navigateTo('/dashboard/email')"
          >
            <button class="flex items-center gap-x-2">
              <svg :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/email', 'fill-gray-400': $route.path !== '/dashboard/email'}"
                   height="1.5rem"
                   viewBox="0 0 512 512"
                   xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/database', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/database'}"
              @click="navigateTo('/dashboard/database')"
          >
            <button class="flex items-center gap-x-2">
              <svg
                  :class="{' dark:fill-gray-800': $route.path === '/dashboard/database', 'fill-gray-400': $route.path !== '/dashboard/database'}"
                  height="1.3rem"
                  viewBox="0 0 448 512"
                  xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/my-orders', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/my-orders'}"
              @click="navigateTo('/dashboard/my-orders')"
          >
            <button class="flex items-center gap-x-2">
              <svg :class="{' dark:fill-gray-800': $route.path === '/dashboard/my-orders', 'fill-gray-400': $route.path !== '/dashboard/my-orders'}"
                   height="1.2rem"
                   viewBox="0 0 576 512"
                   xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/my-invoices', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/my-invoices'}"
              @click="navigateTo('/dashboard/my-invoices')"
          >
            <button class="flex items-center gap-x-2">
              <svg :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/invoices', 'fill-gray-400': $route.path !== '/dashboard/invoices'}"
                   height="1.3rem"
                   viewBox="0 0 384 512"
                   xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/notifications', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/notifications'}"
              @click="navigateTo('/dashboard/notifications')"
          >
            <button class="flex items-center gap-x-1 relative">
              <svg
                  :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/notifications', 'fill-gray-400': $route.path !== '/dashboard/notifications'}"
                  height="1.2rem"
                  viewBox="0 0 448 512"
                  xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/wallet', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/wallet'}"
              @click="navigateTo('/dashboard/wallet')"
          >
            <button class="flex items-center gap-x-2">
              <svg
                  :class="{' dark:fill-gray-800 ': $route.path === '/dashboard/wallet', 'fill-gray-400': $route.path !== '/dashboard/wallet'}"
                  height="1.4rem"
                  viewBox="0 0 512 512"
                  xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/support', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/support'}"
              @click="navigateTo('/dashboard/support')"
          >
            <button class="flex items-center gap-x-2">
              <svg :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/support', 'fill-gray-400': $route.path !== '/dashboard/support'}"
                   height="1.9rem"
                   viewBox="0 0 32 40"
                   x="0px"
                   xmlns="http://www.w3.org/2000/svg"
          ...
          <li
              :class="{'mobile-nav-item' : $route.path === '/dashboard/profile-settings', 'mobile-nav-item-inactive' : $route.path !== '/dashboard/profile-settings'}"
              @click="navigateTo('/dashboard/profile-settings')"
          >
            <button class="flex items-center gap-x-2">
              <svg
                  :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/profile-settings', 'fill-gray-400': $route.path !== '/dashboard/profile-settings'}"
                  height="1.5rem"
                  viewBox="0 0 640 512"
                  xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <li class="btn-base-error col-span-2 mt-2">
            <button class="flex items-center gap-x-2 mx-auto">Log Out</button>
          </li>
          ...
          <li class="col-span-2 mt-5">
            <div class="flex items-center">
              <img
                  alt="userImg"
                  class="rounded-full h-16 w-16 object-cover border-4 border-customGold"
              ...
              <div class="flex flex-col px-5">
                <h2 class="text-2xl font-bold dark:text-gray-300">John Doe</h2>
        ...
        <!--        NOT LOGGED IN NAV-->
        <ul v-else
            class="flex flex-col gap-y-1 mt-5 text-center"
        >
          ...
          <li class="flex">
            <section class="mobile-nav-item w-1/2"
        ...
        <button class="absolute top-10 right-5 text-3xl"
                @click="$store.commit('SET_SHOW_MOBILE_NAV', false)"
        >✖️
        </button>
      </div>
    </transition>
