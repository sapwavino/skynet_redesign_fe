          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg
                  ...
                  height="1.7rem"
                  :class="{'dark:fill-gray-800': $route.path === '/dashboard/domains', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/domains'}">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                   :class="{'dark:fill-gray-800': $route.path === '/dashboard/hosting', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/hosting'}"
                   height="1.2rem">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="" height="1.2rem"
                   :class="{'dark:fill-gray-800': $route.path === '/dashboard/cloud', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/cloud'}">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="1.5rem"
                   :class="{'dark:fill-gray-800': $route.path === '/dashboard/email', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/email'}">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg
                  ...
                  viewBox="0 0 448 512"
                  height="1.3rem"
                  :class="{' dark:fill-gray-800': $route.path === '/dashboard/database', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/database'}">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" height="1.2rem"
                   :class="{' dark:fill-gray-800': $route.path === '/dashboard/my-orders', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/my-orders'}">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"
                   :class="{'dark:fill-gray-800': $route.path === '/dashboard/invoices', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/invoices'}"
                   height="1.3rem">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-1 relative">
              <svg
                  ...
                  :class="{'dark:fill-gray-800': $route.path === '/dashboard/notifications', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/notifications'}">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg
                  ...
                  :class="{' dark:fill-gray-800 ': $route.path === '/dashboard/wallet', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/wallet'}">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 40" x="0px" y="0px"
                   height="1.9rem"
                   :class="{'dark:fill-gray-800': $route.path === '/dashboard/support', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/support'}">
                <g>
                  <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg
                  ...
                  :class="{'dark:fill-gray-800': $route.path === '/dashboard/profile-settings', 'fill-gray-400 dark:fill-customGold': $route.path !== '/dashboard/profile-settings'}">
                <path
