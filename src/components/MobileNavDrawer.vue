<template>
  <div class="md:hidden" @click.stop="$store.commit('SET_SHOW_MOBILE_NAV', false)">
    ...
    <transition name="slide-fade">
      <div v-if="$store.state.showMobileNav" class="mobile-nav-drawer dark:bg-gray-700 bg-white">
        <router-link to="/">
        ...
        <ul class="grid grid-cols-2 gap-y-1 mt-5 text-center" v-if="$store.state.isLoggedIn">
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" class=""
                   :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard', 'fill-gray-400': $route.path !== '/dashboard'}"
                   viewBox="5.0 -20.0 110.0 135.0" height="1.6rem">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                   :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/hosting', 'fill-gray-400': $route.path !== '/dashboard/hosting'}"
                   height="1.2rem">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="" height="1.2rem"
                   :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/cloud', 'fill-gray-400': $route.path !== '/dashboard/cloud'}">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="1.5rem"
                   :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/email', 'fill-gray-400': $route.path !== '/dashboard/email'}">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" height="1.2rem"
                   :class="{' dark:fill-gray-800': $route.path === '/dashboard/my-orders', 'fill-gray-400': $route.path !== '/dashboard/my-orders'}">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"
                   :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/invoices', 'fill-gray-400': $route.path !== '/dashboard/invoices'}"
                   height="1.3rem">
                <path
          ...
          <li
            ...
            <button class="flex items-center gap-x-1 relative">
              <svg
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height="1.2rem"
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="1.4rem"
          ...
          <li
            ...
            <button class="flex items-center gap-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 40" x="0px" y="0px"
                   height="1.9rem"
                   :class="{'dark:fill-customGold fill-customGold': $route.path === '/dashboard/support', 'fill-gray-400': $route.path !== '/dashboard/support'}">
                <g>
                  <path
