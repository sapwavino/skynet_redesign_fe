        ...
        <div class="grid grid-cols-12">
          ...
          >
            ...
            >
              ...
              <div class="w-full md:max-w-[126px]">
                ...
                <svg v-if="item.order_type === 'hosting'"
                     height="6rem"
                     viewBox="0 0 512 512"
                     xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <div class="grid grid-cols-1 md:grid-cols-4 w-full">
                <div class="md:col-span-2">
                  <div class="flex flex-col max-[500px]:items-center">
                    ...
                    <h6 class="font-normal text-base text-gray-500 italic"><strong>Type: </strong>{{
                        item.service_type
                                                                                                  }}</h6>
                    <h6 class="font-normal text-base text-gray-500 italic">
                      <strong>Description: </strong>{{ item.description }}</h6>
                ...
                <div class="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-3 h-full">
                  <p class="font-bold text-lg leading-8 text-gray-600 text-center transition-all duration-300 group-hover:text-indigo-600">
                    {{ getCurrencySymbol($store.state.preferredCurrency) }}
                    {{ convertPrice($store.state.preferredCurrency, item.price) }}</p>
          ...
          >
            <h2 class="font-bold text-3xl leading-10 text-black pb-8 border-b border-gray-300">
              Order Summary</h2>
            <button
                class="btn-base w-full mx-auto my-5"
                @click="$router.back()"
            >
              Continue Shopping
            </button>
            <div class="mt-8">
              <div class="flex items-center justify-between pb-6">
                <p class="font-normal text-lg leading-8 text-black">{{ $store.state.cart.items.length }} {{
                    $store.state.cart.items.length <= 1 ? 'Item' : 'Items'
                                                                    }}</p>
                <p class="font-medium text-lg leading-8 text-black">
                  {{ getCurrencySymbol($store.state.preferredCurrency) }} {{ $store.getters.cartTotal }}</p>
              </div>
              <form>
                ...
                <div class="flex pb-4 w-full">
                  <div class="relative w-full ">
                    ...
                    <input class="block w-full h-11 pr-11 pl-5 py-2.5 text-base font-normal shadow-xs text-gray-900 bg-white border border-gray-300 rounded-lg placeholder-gray-500 focus:outline-gray-400 "
                ...
                >
                  ...
                  {{ convertPrice($store.state.preferredCurrency, $store.getters.cartTotal) }}
                </button>
