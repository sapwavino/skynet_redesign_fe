...
import { convertPrice, formatNumber, getCurrencySymbol } from "../utils/helper_functions.js";
...
<template>
  <div class="mb-5 min-h-[85vh]" v-if="$store.state.cart">
    ...
    <section v-else
      ...
      <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto relative z-10">
        <div class="grid grid-cols-12">
          <div class="col-span-12 xl:col-span-8 lg:pr-8 pt-14 pb-8 lg:py-10 w-full max-xl:max-w-3xl max-xl:mx-auto">
            <div class="flex items-center justify-between pb-8 border-b border-gray-300">
              <h2 class="font-bold text-3xl text-black">Cart</h2>
              <h2 class="font-bold text-xl leading-8 text-gray-600">
                {{ cartItems.length }} {{ cartItems.length <= 1 ? 'Item' : 'Items' }} </h2>
            </div>
            ...
            <div v-for="(item, idx) in cartItems"
              class="flex md:flex-col md:flex-row md:items-center gap-5 py-6  border-b border-gray-400 group pr-5">
              <!--              SVG ICONS-->
              <div class="md:w-full md:max-w-[126px]">
                <svg v-if="item.type === 'domain'" height="8rem" viewBox="0 0 64 80" x="0px"
                ...
                <svg v-if="item.type === 'hosting'" height="6rem" viewBox="0 0 512 512"
                ...
                <svg v-if="item.type === 'cloud'" class="dashLinkSVG" height="6rem" viewBox="0 0 640 512"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <div class="grid grid-cols-1 md:grid-cols-4 w-full">
                <div class="md:col-span-2">
                  <div class="flex flex-col">
                    <h6 class="font-semibold text-base text-black">{{ item.title }}</h6>
                ...
                <div class="flex items-center md:justify-center md:justify-end max-md:mt-3 h-full" v-if="item.price">
                  <p
          ...
          <div
            ...
            <h2 class="font-bold text-3xl leading-10 text-black pb-8 border-b border-gray-300">
              Order Summary</h2>
            <button class="btn-base w-full mx-auto my-5" @click="$router.back()">
              Continue Shopping
            </button>
            <div class="mt-8">
              <form>
                ...
                <div class="flex pb-4 w-full">
                  <div class="relative w-full ">
                    ...
                    <input
                      ...
                      placeholder="xxxx xxxx xxxx" type="text">
                  </div>
                </div>
                <div class="flex items-center border-b border-gray-200">
                  <button class="btn-base-darker w-full mb-5">
                    Apply discount
                  </button>
                </div>
                ...
                <div class="flex gap-x-4 mb-5">
                  ...
                  <div
                    ...
                    <input id="paypal" class="peer hidden" name="radio" type="radio" />
                    <label
                    ...
                    <span class="pointer-events-none z-10">
                      <svg class="ml-5" fill="none" height="2rem" viewBox="0 0 188 49"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <div
                    class="relative flex w-56 items-center justify-center rounded-xl bg-gray-50 px-4 py-3 font-medium text-gray-700">
                    <input id="radio3" checked class="peer hidden" name="radio" type="radio" />
                    <label
                    ...
                    <span class="pointer-events-none z-10">
                      <svg id="Layer_1" class="ml-7" height="1.4rem" viewBox="0 0 280.6 50" x="0px" xml:space="preserve"
                        xmlns="http://www.w3.org/2000/svg" y="0px">
                ...
                <button class="btn-base w-full mx-auto">
                  Pay {{ $store.getters.preferredCurrencySymbol }}
                  {{ formatNumber(convertPrice($store.state.preferredCurrency, $store.state.cart.total)) }}
                </button>
