    ...
    <div class="h-[85vh] w-1/4 px-5 pt-1 border-r border-r-gray-700 overflow-y-auto hidden md:block">
      ...
      <section class="flex flex-col px-5 pb-3 gap-y-1">
        ...
        >
          ...
          <svg :class="{'dashLinkSVG dark:fill-gray-800': $route.path === '/dashboard', 'fill-gray-400 dark:fill-customGold mr-5': $route.path !== '/dashboard'}"
               height="1.5rem"
        ...
        >
          ...
          <svg :class="{'dashLinkSVG dark:fill-gray-800': $route.path === '/dashboard/hosting', 'fill-gray-400 dark:fill-customGold mr-5': $route.path !== '/dashboard/hosting'}"
               height="1.5rem"
               viewBox="0 0 512 512"
               xmlns="http://www.w3.org/2000/svg"
          >
        ...
        >
          ...
          <svg :class="{'dashLinkSVG dark:fill-gray-800': $route.path === '/dashboard/email', 'fill-gray-400 dark:fill-customGold mr-5': $route.path !== '/dashboard/email'}"
               class="dashLinkSVG"
               height="1.5rem"
               viewBox="0 0 512 512"
               xmlns="http://www.w3.org/2000/svg"
      ...
      <section class="flex flex-col p-5 gap-y-1">
        ...
        >
          ...
          <svg :class="{'dashLinkSVG dark:fill-gray-800': $route.path === '/dashboard/my-orders', 'fill-gray-400 dark:fill-customGold mr-6': $route.path !== '/dashboard/my-orders'}"
               height="1.2rem"
               viewBox="0 0 576 512"
               xmlns="http://www.w3.org/2000/svg"
          >
        ...
        >
          ...
          <svg :class="{'dashLinkSVG dark:fill-gray-800': $route.path === '/dashboard/invoices', 'fill-gray-400 dark:fill-customGold mr-7': $route.path !== '/dashboard/invoices'}"
               height="1.5rem"
               viewBox="0 0 384 512"
               xmlns="http://www.w3.org/2000/svg"
          >
        ...
        >
          ...
          <div v-show="unreadNotifications > 0"
               class="absolute right-[5%] bg-green-500 text-gray-50 rounded-full py-1 px-3 text-sm"
          >{{ unreadNotifications }}
          </div>
        ...
        >
          ...
          <svg :class="{'dashLinkSVG dark:fill-gray-800': $route.path === '/dashboard/support', 'fill-gray-400 dark:fill-customGold mr-3': $route.path !== '/dashboard/support'}"
               class="dashLinkSVG"
               height="1.9rem"
               viewBox="0 0 32 40"
               x="0px"
